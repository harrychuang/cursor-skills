...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, minmax(0, 1fr))', gap: 16, marginTop: 24 }}>
  <section style={{ gridColumn: 'span 6', padding: 24, borderRadius: 28, background: '#f0fdf4', border: '1px solid #86efac' }}>
    ...
    <p style={{ marginBottom: 0 }}>Document the spacing system as bands, not isolated numbers. Teams remember `compact`, `base`, and `spacious` more reliably than raw pixel tables.</p>
  </section>
  <section style={{ gridColumn: 'span 6', padding: 24, borderRadius: 28, background: '#ecfeff', border: '1px solid #67e8f9' }}>
    ...
    <p style={{ marginBottom: 0 }}>Explain when the product is allowed to compress: mobile constraints, data-heavy screens, or utility views. Compression should happen by band, not random exception.</p>
  </section>
  <section style={{ gridColumn: 'span 4', padding: 20, borderRadius: 24, background: '#f8fafc', border: '1px solid #cbd5e1' }}>
    ...
    <p style={{ margin: 0 }}>Internal gaps: icon-label pairs, helper text offsets, pill padding, or tightly grouped metadata.</p>
  </section>
  <section style={{ gridColumn: 'span 4', padding: 20, borderRadius: 24, background: '#fefce8', border: '1px solid #fde047' }}>
    ...
    <p style={{ margin: 0 }}>Default component padding and the most common gap between sibling elements inside cards, forms, and list items.</p>
  </section>
  <section style={{ gridColumn: 'span 4', padding: 20, borderRadius: 24, background: '#fff7ed', border: '1px solid #fdba74' }}>
    ...
    <p style={{ margin: 0 }}>Section gaps, panel spacing, and page gutters. Use these steps to signal structural change, not to patch weak composition.</p>
  </section>
</div>
