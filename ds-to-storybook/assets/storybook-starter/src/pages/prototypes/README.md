...
This starter ships without a sample prototype. Create your first folder under `src/pages/prototypes/<feature-prototype>/` using the `prototype-storybook-flow` skill.
