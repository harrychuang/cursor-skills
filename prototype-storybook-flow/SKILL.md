...
Use this skill to take a product idea from PRD to a clickable Storybook prototype with a metadata-driven UI Flow. The reference implementation is `src/pages/prototypes/inventory-prototype`.
